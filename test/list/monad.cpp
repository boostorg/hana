...
int main() {
    BOOST_HANA_STATIC_ASSERT(unit<_List>(int_<0>) == list(int_<0>));
    BOOST_HANA_STATIC_ASSERT(unit<_List>(int_<1>) == list(int_<1>));
    BOOST_HANA_STATIC_ASSERT(unit<_List>(3) == list(3));
