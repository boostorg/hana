...
void test() {
    ...
    BOOST_HANA_STATIC_ASSERT(or_(logical(true)) == logical(true));
    ...
    BOOST_HANA_STATIC_ASSERT(or_(logical(false), logical(true)) == logical(true));
    // BOOST_HANA_STATIC_ASSERT(or_(logical(true), invalid));

    BOOST_HANA_STATIC_ASSERT(or_(logical(false), logical(false), logical(false)) == logical(false));
    BOOST_HANA_STATIC_ASSERT(or_(logical(false), logical(false), logical(true)) == logical(true));
