...
int main() {
    ...
    // is_empty
    {
        ...
        BOOST_HANA_CONSTANT_ASSERT(not_(is_empty(mpl::vector<x1>{})));
        BOOST_HANA_CONSTANT_ASSERT(not_(is_empty(mpl::vector1<x1>{})));

        BOOST_HANA_CONSTANT_ASSERT(not_(is_empty(mpl::vector<x1, x2>{})));
        BOOST_HANA_CONSTANT_ASSERT(not_(is_empty(mpl::vector2<x1, x2>{})));
    }
}
