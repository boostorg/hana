...
#ifndef BOOST_HANA_TEST_COMPARABLE_MCD_EQUAL_MINIMAL_HPP
#define BOOST_HANA_TEST_COMPARABLE_MCD_EQUAL_MINIMAL_HPP
...
#endif // !BOOST_HANA_TEST_COMPARABLE_MCD_EQUAL_MINIMAL_HPP
