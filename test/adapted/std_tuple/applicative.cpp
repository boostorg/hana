...
int main() {
    BOOST_HANA_STATIC_ASSERT(pure<StdTuple>(int_<0>) == tuple(int_<0>));
    BOOST_HANA_STATIC_ASSERT(pure<StdTuple>(int_<1>) == tuple(int_<1>));
    BOOST_HANA_STATIC_ASSERT(pure<StdTuple>(3) == tuple(3));
