...
int main() {
    ...
    BOOST_HANA_STATIC_ASSERT(detail::laws<Functor>(std::make_tuple(), f, g));
    BOOST_HANA_STATIC_ASSERT(detail::laws<Functor>(std::make_tuple(int_<1>), f, g));
    BOOST_HANA_STATIC_ASSERT(detail::laws<Functor>(std::make_tuple(int_<1>, int_<2>), f, g));
    BOOST_HANA_STATIC_ASSERT(detail::laws<Functor>(std::make_tuple(1, 2, 3), f, g));
}
