...
void test(R result) {
    ...
    BOOST_HANA_CONSTANT_ASSERT(variadic::foldr1<Ts...>(mf) == result);
    BOOST_HANA_CONSTANT_ASSERT(variadic::foldr1<Ts...>(f) == result);
    BOOST_HANA_CONSTANT_ASSERT(variadic::foldr1(mf, type<Ts>...) == result);
    BOOST_HANA_CONSTANT_ASSERT(variadic::foldr1(f, type<Ts>...) == result);
}
