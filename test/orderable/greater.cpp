...
void test() {
    ...
    BOOST_HANA_CONSTEXPR_ASSERT(greater(orderable(1), orderable(0)));
    BOOST_HANA_CONSTEXPR_ASSERT(not_(greater(orderable(0), orderable(0))));
    BOOST_HANA_CONSTEXPR_ASSERT(not_(greater(orderable(0), orderable(1))));
