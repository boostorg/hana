...
namespace experimental {
    ...
    struct make_impl<view_tag> {
        template <typename Xs>
        static constexpr experimental::identity_view_t<Xs> apply(Xs& xs)
        { return {xs}; }
    };
    ...
    struct unpack_impl<hana::view_tag> {
        ...
        static constexpr decltype(auto) apply(experimental::identity_view_t<Xs> view, F&& f) {
    ...
    struct at_impl<hana::view_tag> {
        ...
        static constexpr decltype(auto) apply(experimental::identity_view_t<Xs> view, N const& n) {
    ...
    struct length_impl<hana::view_tag> {
        ...
        // identity_view
        template <typename Xs>
        static constexpr auto apply(experimental::identity_view_t<Xs> const& view) {
            return hana::length(view.sequence_);
        }
    };
    ...
    struct transform_impl<hana::view_tag> {
        ...
        template <typename Sequence, typename F>
        static constexpr auto apply(experimental::identity_view_t<Sequence> view, F&& f) {
            return experimental::transformed(view.sequence_, static_cast<F&&>(f));
        }
    ...
    struct flatten_impl<hana::view_tag> {
        template <typename Sequence>
        static constexpr auto apply(experimental::identity_view_t<Sequence> view) {
            return experimental::flattened(view.sequence_);
        }
