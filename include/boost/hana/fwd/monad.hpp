...
namespace boost { namespace hana {
    ...
    //! for all functions `h, g, k` with a suitable signature for the
    //! composition to make sense:
    //! @code
    //!     mcompose<M>(lift<M>, g)           == g                                 // left identity
    //!     mcompose<M>(g, lift<M>)           == g                                 // right identity
    //!     mcompose<M>(mcompose<M>(g, h), k) == mcompose<M>(g, mcompose<M>(h, k)) // associativity
    //! @endcode
    ...
    //! Example
    //! -------
    //! @snippet example/monad.cpp bind
