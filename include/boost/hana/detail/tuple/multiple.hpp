/*!
@file
Defines `boost::hana::detail::multiple::tuple`.
...
#ifndef BOOST_HANA_DETAIL_TUPLE_MULTIPLE_HPP
#define BOOST_HANA_DETAIL_TUPLE_MULTIPLE_HPP
...
namespace boost { namespace hana {
    namespace detail { namespace multiple {
        struct Tuple {
            struct hana {
        ...
        struct tuple
            ...
            , operators::Iterable_ops<tuple<Xs...>>
        {
            using closure<Xs...>::closure; // inherit constructor
            struct hana { using datatype = Tuple; };
        };

        struct utils {
            template <typename ...Xs>
            static constexpr detail::std::size_t get_size(tuple<Xs...> const*)
            { return sizeof...(Xs); }

            template <detail::std::size_t n, typename Xn>
            static constexpr decltype(auto) get_element(element<n, Xn> const& x)
            { return x.get; }

            template <detail::std::size_t n, typename Xn>
            static constexpr decltype(auto) get_element(element<n, Xn>& x)
            { return x.get; }
        ...
        constexpr detail::create<tuple> make_tuple{};
    }}
    ...
    template <>
    struct Foldable::instance<detail::multiple::Tuple> : Foldable::unpack_mcd {
    ...
    template <>
    struct Iterable::instance<detail::multiple::Tuple>
        : Iterable::mcd,
          detail::multiple::utils
    {
        // at
        ///////////////
        ...
        #define BOOST_HANA_PP_TAIL(REF)                                         \
            ...
            static constexpr detail::multiple::tuple<typename Xn::get_type...>  \
        ...
        template <typename ...Xs>
        static constexpr decltype(auto)
        is_empty_impl(detail::multiple::tuple<Xs...> const&)
    ...
    template <>
    struct List::instance<detail::multiple::Tuple>
        : List::mcd<detail::multiple::Tuple>,
          detail::multiple::utils
    {
        // concat
        ///////////////
        #define BOOST_HANA_PP_CONCAT2(REF1, REF2)                           \
            ...
            static constexpr detail::multiple::tuple<                       \
        ...
        init_helper(Xs&& xs, detail::std::index_sequence<n...>) {
            return detail::multiple::make_tuple(
                get_element<n>(detail::std::forward<Xs>(xs))...
            );
        }
        ...
        // make and nil
        ///////////////
        static constexpr auto make_impl = detail::multiple::make_tuple;
        static constexpr detail::multiple::tuple<> nil_impl() { return {}; }
        ...
        slice_helper(Xs&& xs, detail::std::index_sequence<i...>) {
            return detail::multiple::make_tuple(
                get_element<from + i>(detail::std::forward<Xs>(xs))...
            );
        }
        ...
        #define BOOST_HANA_PP_ZIP1(REF)                                     \
            template <typename ...Xs>                                       \
            static constexpr detail::multiple::tuple<                       \
                detail::multiple::tuple<typename Xs::get_type>...           \
    ...
    template <>
    struct Functor::instance<detail::multiple::Tuple>
        : Functor::fmap_mcd,
          detail::multiple::utils
    {
        // fmap
        ...
        template <typename V>
        static constexpr detail::multiple::tuple<>
        fill_impl(detail::multiple::tuple<> const&, V&& v)
        { return {}; }
        ...
        > fill_impl(detail::multiple::tuple<X, Xs...> const&, V&& v) {
...
#endif // !BOOST_HANA_DETAIL_TUPLE_MULTIPLE_HPP
